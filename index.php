...
<body>
  ...
  <div class="container mt-80">
    <div class="row justify-content-center">
      <div class="col-lg-8">
        <div class="heading-block">
          ...
          <div class="main-btn-wrap">
            <a href="about-us.php" class="main-btn btn"
              style="margin-top: -10px; margin-bottom: 20px; color:white;">Read More</a>
          </div>
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-lg-12">
        <div class="flexible-slider wow fadeInUp" data-items="4" data-items-992="2" data-items-768="1"
  ...
  <!----------------------- Banner-part------A.A  -->
  <div class="pt-50 pb-50 mt-80 lazy-background-unique" style="
    ...
    <div class="container justify-content-end">
      <div class="row banner-row align-items-center">
        ...
        <div class="col-lg-8 pr-40 wow fadeInLeft" style="color: white">
          <h3 class="heading font-bold text-lh-4 pb-4 wow fadeInLeft" style="color: white">
          ...
          <a href="book-appointment.php" class="btn btn-primary btn-lg ml-40">Book Appointment</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="pt-50 bg-light lazy-background-unique" style="
  ...
  <div class="container mt-50">
    ...
    <div class="container-flude m-5 mt-0 owl-theme" id="google-review-container" style="padding-top: 50px">
      <div class="row">
        <div class="col-12">
                ...
                <div class="row">
                  <div class="col">
                    <div class="card p-3 review-card">
                      ...
                      <div class="card-body">
                        <p style="color: #fb8e28; font-size: 20px" class="card-text">
                          ★★★★★
                          <!-- ★★★★☆ -->
                        </p>
                ...
                <div class="row">
                  <div class="col">
                    <div class="card p-3 review-card">
                      <div class="d-flex m-">
                        <div
                          style="width: 50px;height: 50px; border-radius:50%; background-color: #78909c; display: flex; align-items: center; justify-content: center;">
                      ...
                      <div class="card-body">
                        ...
                        <div class="card-review-container-container">
                          <p class="card-text">
                            “Thank you pritimala maam for your efforts and guidance. Because of your precise decesions
                            and experince of correct mediciation our family is completed. Highly recommended."
                          </p>
                        </div>
                      </div>
                      <div class="google-svg">
                ...
                <div class="row">
                  <div class="col">
                    <div class="card p-3 review-card">
                      <div class="d-flex m-">
                        <div
                          style="width: 50px;height: 50px; border-radius:50%; background-color: red; display: flex; align-items: center; justify-content: center;">
                      ...
                      <div class="card-body">
                        ...
                        <div class="card-review-container-container">
                          <p class="card-text">
                            “Awesome clinic and doctor pritimala is superb. She is best doctor I have ever met she
                            listen very carefully to you and understand your concern. She gives her best to there
                            patients. Thanku so much doctor."
                          </p>
                        </div>
                      </div>
                      <div class="google-svg">
    ...
    <div class="row align-items-center">
      <div class="col-lg-6 col-12 pl-lg-30 mt-20">
        <div id="a2" class="accordion-2 wow fadeInLeft" role="tablist">
          <div class="accordion-item">
            <h3 class="heading font-bold text-lh-4 text-primary pb-4 wow fadeInLeft">
          ...
          <div class="accordion-item">
            <div class="accordion-heading" role="tab" id="a2heading2">
              <h6 class="accordion-title font-bold">
                <a class="collapsed" role="button" data-toggle="collapse" href="#a2body2" aria-expanded="false"
          ...
          <div class="accordion-item">
            <div class="accordion-heading" role="tab" id="a2heading3">
              <h6 class="accordion-title font-bold">
                <a class="collapsed" role="button" data-toggle="collapse" href="#a2body3" aria-expanded="false"
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="section-title-wrap text-center wow fadeInLeft">
            <!--Section Title-->
            <div class="heading-block">
              <h2 class="heading font-bold text-lh-4 text-primary pb-4 wow fadeInLeft">
            ...
            <div class="shadow rounded border border-black h-100">
              ...
              <div class="home-blog-card-img-container">
                <img
                  ...
                  alt="" class="img-fluid w-100 rounded-top" style="height:200px; object-fit:cover;" />
              </div>
              ...
              <div class="home-blog-card-content p-20">
                ...
                <div class="home-blog-card-btn">
                  <a href="https://pearlfertilityandivf.com/blogs/<?php echo htmlspecialchars($blog['slug']); ?>"
