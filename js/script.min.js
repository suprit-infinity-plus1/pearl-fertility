...
function currentMenuItem() {
  ...
  $(".navbar-nav .menu-items a").each(function () {
    t($(this).attr("href")) == t(e) &&
...
function mobileMenuToggle() {
  $(window).width() < 992 &&
    $(".has-menu > a").on("click", function (e) {
      e.preventDefault(), $(this).parent().toggleClass("open-menu");
    });
}
function stickyNav(e) {
  ...
  window.addEventListener("scroll", function (o) {
    var i = window.pageYOffset || document.documentElement.scrollTop,
      a = $(".sticky-nav");
    i > 400
      ? ($(e).css({ height: t + "px" }), a.addClass("stick"))
      : a.hasClass("stick") && a.removeClass("stick");
  });
}
  ...
  e.on("scroll resize", function () {
    ...
    $(".parallax").each(function () {
      var o,
        ...
        n = i.data("speed") || 0;
      e.on("scroll resize", function () {
        (o = "50% " + -(t - a) / n + "px"), i.css({ backgroundPosition: o });
      });
    }),
    e.trigger("scroll");
}
...
function flexibleSlider(e) {
  $(e)
    ...
    .slick({
      ...
      appendDots: $(e).find(".slider-dots"),
      responsive: [
        { breakpoint: 992, settings: { slidesToShow: $(e).data("items-992") } },
        { breakpoint: 768, settings: { slidesToShow: $(e).data("items-768") } },
...
function countdownTimer(e) {
  ...
  $(e).countdown(t, function (e) {
    $(this).find(".days").html(e.strftime("%D")),
      $(this).find(".hours").html(e.strftime("%H")),
      $(this).find(".minutes").html(e.strftime("%M")),
      $(this).find(".seconds").html(e.strftime("%S"));
  });
}
...
function youtubeVideo(e) {
  var t,
    o = $(e).attr("data-video-id"),
    i = $(e).attr("data-video-thumbnail");
  (t = i
    ? "url(" + i + ")"
    : "url(https://img.youtube.com/vi/" + o + "/sddefault.jpg)"),
  ...
  var e = {
    ...
    beforeSend: function () {
      $("#status")
        .empty()
        .html(
          "<i class='ion-time-outline'></i>Submitting your message, please wait."
        );
    },
...
function googleMapStyle(e, t, o, i) {
  ...
  (l.infowindow = new google.maps.InfoWindow({ content: o })),
...
$(window).on("load", function () {
  ...
  $(document).ready(function () {
    ($(".navbar-nav").length && currentMenuItem(),
    $(".has-menu").length && mobileMenuToggle(),
    $(".sticky-nav").length) && stickyNav($(".sticky-nav").parents("header"));
    $(".parallax").length && $(window).width() > 960 && backgroundParallax(),
      $(".news-slider").length &&
        $(".news-slider").each(function () {
          newsSlider(this);
        }),
      $(".testimonial-1").length &&
        $(".testimonial-1").each(function () {
          testimonialSlider1(this);
        }),
      $(".department-slider").length &&
        $(".department-slider").each(function () {
          departmentSlider(this);
        }),
      $(".flexible-slider").length &&
      ...
      $(".date-select").length && dateSelect(),
      $("#fixed-appointment").length && fixedAppointment(),
      $(".timer").length &&
        $(".timer").each(function () {
          countdownTimer(this);
        }),
      ...
      $("#back").length && backToTop(),
      $("#slider-1").length && sliderRevolution1(),
      $("#slider-2").length && sliderRevolution2(),
      $(".youtube-video").length &&
        $(".youtube-video").each(function () {
          youtubeVideo(this);
        }),
      $("a[data-gal^='prettyPhoto']").length && prettyPhotoGallery(),
      $("#main-contact-form").length && formSubmit(),
      $("footer .tweets").length &&
